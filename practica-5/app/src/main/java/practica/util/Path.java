...
public class Path {
    public static class Web {
        ...
        public static final String FETCH_ARTICLES = "/articulos";
        public static final String FETCH_CHATS = "/chats";
        public static final String BLOG_PAG = "/pagina/{pagina}";
        public static final String LOGIN = "/login";
        public static final String CHAT = "/chat";
        public static final String CHATTO = "/chat/{to}";
    ...
    public static class Template {
        ...
        public static final String CHAT = "/velocity/chat.vm";
        public static final String CHATTO = "/velocity/chatTo.vm";
